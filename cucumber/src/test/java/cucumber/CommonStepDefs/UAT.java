...
//            getDriver().get("https://testcommunity.ascendify.works/");
//        } else if (arg0.equalsIgnoreCase("TC Login")) {
//            getDriver().get("https://master.client.ascendify.works/");
...
//
//        getDriver().findElement(By.xpath("//input[@id='id_username']")).sendKeys("tessy.mathew@ascendify.com");
