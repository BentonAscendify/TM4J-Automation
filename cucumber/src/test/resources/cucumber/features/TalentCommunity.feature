...
Feature: Talent Community
  ...
  Scenario: Join community via email
    Given I navigate to "TC login" page TC
  ...
  Scenario: Apply to a job by sign-in to a community
    ...
    And I type "email" as "tessy@gmail.com" TC
    And I type password "Ascendify246!" on "sign in" page TC
  ...
  Scenario: Login/SignUp via Social
    Given I navigate to "LinkedIn" page TC
...
#    NOTE:Use a valid LinkedIn email and password that is not present in the Ascendify Database
    And I type "LinkedIn email" as "2arjunsreekumar9@unoutta.cf" TC
    And I type password "Mac123q!" on "LinkedIn Sign In" page TC
