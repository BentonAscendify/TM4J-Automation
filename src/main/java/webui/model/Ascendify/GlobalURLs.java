...
public class GlobalURLs {
    ...
    public static String AscendifyTalentCommunityWorks = "https://master.client.ascendify.works";
    public static String AscendifyTalentCommunityWorksSignin = "https://master.client.ascendify.works/signin";
    public static String AscendifyAppProd = "https://testcommunity.ascendify.com/";
    public static String AscendifyTalentCommunityProd = "https://master.ascendify.net";
